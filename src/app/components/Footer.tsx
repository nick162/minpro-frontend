  ...
  return (
    <footer className="bg-gray-900">
        ...
        <div className="grid md:grid-cols-3 gap-7">
          <div>
            <Link href="/" className="mb-10 block">
              <Image src="/cs-1.png" width={128} height={49} alt="logo" />
              <p className="text-gray-400">
                Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                Repellat vel, blanditiis deserunt repellendus placeat beatae.
              </p>
            </Link>
          </div>
          <div>
            <div className="flex gap-20">
              <div className="flex-1 md:flex-none">
                ...
                <ul className="list-item space-y-5 text-gray-400">
                  ...
                  <li>
                    <Link href="/event">EVENT GALLERY</Link>
                  </li>
                  <li>
      ...
      <div className="max-w-screen-xl mx-auto px-4 border-t border-gray-500 py-8 text-center text-base text-gray-500">
        &copy; Copyright 2025 | INDOEVENT | All Right Reserved
      </div>
    </footer>
  );
}
